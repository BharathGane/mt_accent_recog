...
optimizer = optim.SGD(model.parameters(), lr=0.0001, momentum=0.5, weight_decay= 0.0005)
exp_lr_scheduler = lr_scheduler.MultiStepLR(optimizer, milestones=map(lambda x: x*5,range(10)), gamma=0.1)
