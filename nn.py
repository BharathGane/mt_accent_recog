...
class MyNet(nn.Module):
    def __init__(self):
        ...
        self.pool2_branch4 = nn.MaxPool1d(kernel_size=15, stride=15)
        self.pool2_branch5 = nn.MaxPool1d(kernel_size=15, stride=15)
        self.pool2_branch6 = nn.MaxPool1d(kernel_size=15, stride=15)
        self.pool2_branch7 = nn.MaxPool1d(kernel_size=15, stride=15)
        self.pool2_branch8 = nn.MaxPool1d(kernel_size=15, stride=15)
        self.pool2_branch9 = nn.MaxPool1d(kernel_size=15, stride=15)
        self.pool2_branch10 = nn.MaxPool1d(kernel_size=15, stride=15)
        self.pool2_branch11 = nn.MaxPool1d(kernel_size=15, stride=15)
        self.pool2_branch12 = nn.MaxPool1d(kernel_size=15, stride=15)
    ...
    def forward(self, x):
        ...
        # h = x1
        h = torch.cat((x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12), dim=2) 
